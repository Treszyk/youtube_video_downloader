...
class Sidebar(ctk.CTkFrame):
    ...
    def highlight_button(self, index):
        for i, button in enumerate(self.tab_buttons):
            if i == index:
                button.configure(fg_color="#ffc86b")  # Active
